  ...
  do
    ...
    do
      ...
      do
        ...
        --link $LINK --random_weight $RANDOM_WEIGHT --array $SLURM_ARRAY_TASK_ID\
...
#python avg_corr/main.py --path './exper/cartpole.pth' --env 'CartPole-v1' --log_dir $SCRATCH/avg_mse/cartpole/ --steps 5 --epoch 500 --max_len 50 --seed 32