...
# buf = collect_dataset(env, 0.95, buffer_size=80, max_len=50, path='./exper/cartpole.pth',
#                       random_weight=0.5, fold=1)
# second_buf = collect_dataset(env, 0.95, buffer_size=80, max_len=50, path='./exper/cartpole.pth',
#                       random_weight=0.5, fold=1)
# temporal_error(buf,second_buf,0.95)